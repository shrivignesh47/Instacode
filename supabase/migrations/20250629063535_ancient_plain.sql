/*
  ...
  2. Triggers
    - Add triggers to automatically create notifications for relevant events

  3. Security
    - All functions use explicit schema references
...
CREATE POLICY "Users can insert notifications"
  ...
  FOR INSERT
  TO authenticated
  WITH CHECK ((auth.uid() = sender_id) OR (role() = 'service_role'));
