...
const CodingChallengesPage = () => {
  ...
  // Check if current user is the specific user who should see the create button
    ...
    <div className="max-w-6xl mx-auto px-4 lg:px-0">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {/* Create Challenge Button - Only visible to authorized user */}
          {isAuthorizedUser && (
                    ...
                    <div key={entry.user_id} className="flex items-center justify-between">
                      <div className="flex items-center space-x-3">
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          />
                          <span className="text-white text-sm font-medium truncate max-w-[100px] sm:max-w-[150px]">{entry.profiles.display_name || entry.profiles.username}</span>
                        </div>
                      </div>
                ...
                <>
                  {challenges
                    ...
                    .map(challenge => (
                      ...
                      >
                        <h4 className="text-white font-medium mb-1 truncate">{challenge.title}</h4>
